...
<div>
    ...
    <div style="margin: 15px; padding: 10px;">
        ...
        <div style="display: inherit">
            ...
            <h4 style="display: block">Proficient in takes videos/pictures of Work in progress and sharing them. Commenting code and choosing descriptive names</h3>
        </div>
    </div>
    <div style="margin: 15px; padding: 10px;">
        ...
        <div style="display: inherit">
            <p style="display: inline">🔳🔳🔳🔳🔳🔳⬜️⬜️⬜️⬜️</p>
            <h4 style="display: block">Comfortable as I have taken delegate tasks to other teammembers</h3>
        </div>
    </div>
    <div style="margin: 15px; padding: 10px;">
        ...
        <div style="display: inherit">
            ...
            <h4 style="display: block">Familiar with the asset pipeline process</h3>
        </div>
    </div>
</div>